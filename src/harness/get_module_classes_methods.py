from usefulPythonShellFunctions import *
import typing, re
from inspect import signature as get_signature
from typing import get_type_hints, Optional, Union, Dict, List, Tuple, Set
...
def get_module_classes(
	...
	filt_classes = filterGlobalsListByType(obj=mod, desiredType=typing.Type)
...
def get_module_classes_methods(
	...
	for i in classes:
		filt_funcs = filterGlobalsListByType(
			obj = getattr(mod, i),
...
def get_module_type_aliases(
	...
	filt_aliases = filterGlobalsListByType(obj=mod, desiredType=typing._GenericAlias)
...
def module_types(module):
	return [t[0] for t in filterGlobalsListByType(obj=module, desiredType=typing.Type)]
